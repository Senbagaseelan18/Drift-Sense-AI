...
OUT = Path(__file__).resolve().parents[1] / "results" / "generated_dataset_images" / "dram_73"
# =========================================================================
...
# =========================================================================
# LAYOUT & GEOMETRY ENGINE (OVAL ARRAY - NO SYMBOLS)
# =========================================================================

def draw_oval_array_layout(width_px, height_px, pixel_scale_nm, start_x_nm, start_y_nm, meta):
    BACKGROUND = 35.0
    ...
    img[peripheral_mask] = 20.0 # Dark scribe lines separating sections
    ...
    # ZERO FIDUCIAL SYMBOLS DRAWN

    return img

def generate_pair(index):
    # FIXED SEED hardcoded to 54321
    master_seed = 54321
    np.random.seed(master_seed)
    
    meta = {
        "architecture": "oval_array_intersection_crop",
        "pair_id": index,
        "seed": master_seed,
    ...
    # =========================================================================
    # EXACT INTERSECTION LOGIC (NO SYMBOLS, JUST CROP AT THE CROSSROADS)
    # =========================================================================
    # The grid uses "mat_size_nm" (the block of features) followed by "strip_width_nm" (the gap).
    # This means the center of the vertical gap is exactly at `mat_size_nm + (strip_width_nm / 2)`.
    ...
    print(f"Generating Dataset: Ovals with Section-Intersection Crop (Seed: {master_seed})...")
    print(f"  Cropping Reference exactly at MACRO-INTERSECTION: X={meta['gt_x']}, Y={meta['gt_y']}")

    # =========================================================================
    # SEARCH IMAGE GENERATION
    # =========================================================================
    # Generate directly at 1000x1000 with 10 nm/px to avoid expensive 10000x10000 work
    search_clean_1nm = draw_oval_array_layout(
    ...
    ref_clean = draw_oval_array_layout(
...
def main():
    ...
    generate_pair(1)
    print("Dataset generation complete! Files saved in 'dataset_ovals_intersection_crop'.")
